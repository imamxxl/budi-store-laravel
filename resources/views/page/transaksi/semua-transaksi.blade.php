        ...
        <div class="row">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title center">Daftar Transaksi</h3>
                </div>

                <div class="box-body">
                    <button type="button" class="btn btn-lg bg-blue color-palette fa fa-plus" data-toggle="modal"
                        data-target="#modal-tambah">
                        Buat Transaksi
                    </button>
                    <a href="" class="btn btn-lg btn-default fa fa-trash"> Tong Sampah </a>
                </div>
                            ...
                            @foreach ($transaksi as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="" class="btn btn-sm bg-orange">
                                            <i class="fa fa-fw fa-shopping-cart"></i>
                                        </a>
